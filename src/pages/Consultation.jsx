...
export default function Consultation({ isStandalone = true }) {
  ...
  return (
    <>
      <SEO
        title="Free Consultation | Find Your Signature Scent"
        description="Get a personalized perfume consultation from Sam Perfumes experts. Find your perfect fragrance match today."
        keywords="perfume consultation, fragrance advice, signature scent, personalized perfume"
        image="https://sam-perfume.vercel.app/og-image.jpg"
        url="https://sam-perfume.vercel.app/consultation"
        ogType="website"
      />
      <div
        style={{
