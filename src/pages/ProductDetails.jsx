...
export default function ProductDetails() {
  ...
  const productImage =
    product && getProductImage(product, 0)
      ? getProductImage(product, 0)
      : "https://sam-perfume.vercel.app/og-image.jpg";
  const productName = product ? getProductName(product, lang) : "Perfume";
  ...
  return (
    <>
      <SEO
        ...
        keywords={`${productName}, perfume, fragrance, luxury scent`}
        image={productImage}
        url={`https://sam-perfume.vercel.app/product/${id}`}
        ogType="product"
      />
      <div
